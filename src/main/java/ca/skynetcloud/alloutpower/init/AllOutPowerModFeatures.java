...
import ca.skynetcloud.alloutpower.world.features.ores.Holy_IngotOreFeature;

@Mod.EventBusSubscriber(bus = Mod.EventBusSubscriber.Bus.MOD)
public class AllOutPowerModFeatures {
	private static final Map<Feature<?>, FeatureRegistration> REGISTRY = new HashMap<>();
	static {
		REGISTRY.put(Holy_IngotOreFeature.FEATURE, new FeatureRegistration(GenerationStep.Decoration.UNDERGROUND_ORES,
				Holy_IngotOreFeature.GENERATE_BIOMES, Holy_IngotOreFeature.CONFIGURED_FEATURE));
	}
